...
public class WeixinUtil {
	...
	public static String AUTH_URL="https://open.weixin.qq.com/connect/oauth2/authorize?appid=APPID&redirect_uri=REDIRECTURI&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect";
	public static String ACCESS_URL="https://api.weixin.qq.com/sns/oauth2/access_token?appid=APPID&secret=SECRET&code=CODE&grant_type=authorization_code";
    ...
    public static JSONObject httpRequest(String requestUrl, String requestMethod, String outputStr) {
        ...
        try {
                ...
                //jsonObject = JSONObject.toJSON(buffer.toString());
	...
	/**
	 * 获取access_token
	 * @param weixinAccesstokenServer
	 * @param weixinAccount
	 * @return
	 */
    public static WeixinAccessToken getAccessToken(WeixinAccesstokenServer weixinAccesstokenServer, WeixinAccount weixinAccount) {
    	// 第三方用户唯一凭证
//        String appid = bundle.getString("appId");
//        // 第三方用户唯一凭证密钥
//        String appsecret = bundle.getString("appSecret");
        
    	WeixinAccessToken accessTocken = getRealAccessToken(weixinAccesstokenServer,weixinAccount);
    	try{
        	if(null!=accessTocken){
        		Date end = new Date();
        		log.info("timeLong:"+(end.getTime()-accessTocken.getAddtime().getTime()));
        		log.info("timeLong:"+(accessTocken.getExpiresIb()*1000));
            	if(end.getTime()-accessTocken.getAddtime().getTime()>=(accessTocken.getExpiresIb()*250)){
                     ...
                     if (null != jsonObject) {
                         try {
                        	 ...
                        	 accessTocken.setExpiresIb(jsonObject.getInteger("expires_in"));
                           ...
                           ///accessToken.set
                            updateAccessToken(ticketAccessToken,weixinAccesstokenServer);
                             return accessTocken;
                         } catch (Exception e) {	
                             // 获取token失败
                 ...
                 if (null != jsonObject) {
                     try {
                         ...
                         accessToken.setExpiresIb(jsonObject.getInteger("expires_in"));
                         ...
                         saveAccessToken(ticketAccessToken,weixinAccesstokenServer);
                     } catch (Exception e) {
                         accessToken = null;
                         // 获取token失败
                         String wrongMessage = "获取token失败 errcode:{} errmsg:{}"+jsonObject.getInteger("errcode")+jsonObject.getString("errmsg");
     ...
     * @return
     */
    public static String getTicket(WeixinAccesstokenServer accessTokenYwManageImpl, WeixinAccount weixinAccount){
     ...
     * @return
     */
    public static WeixinAccessToken getRealAccessToken(WeixinAccesstokenServer WeixinAccesstokenServer, WeixinAccount weixinAccount){
        List<WeixinAccessToken> accessTockenList = WeixinAccesstokenServer.findByAccountId(weixinAccount.getDbid());
     ...
     * @return
     */
    public static void saveAccessToken(WeixinAccessToken accessTocken, WeixinAccesstokenServer accessTokenYwManageImpl){
     ...
     * @return
     */
    public static void updateAccessToken(WeixinAccessToken accessTocken, WeixinAccesstokenServer accessTokenYwManageImpl){
