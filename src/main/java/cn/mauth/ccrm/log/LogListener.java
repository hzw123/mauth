...
import cn.mauth.ccrm.core.util.IpUtil;
...
public class LogListener  implements PostInsertEventListener,PostUpdateEventListener,PostDeleteEventListener{
	public final static Logger log= LoggerFactory.getLogger(LogListener.class);
	 ...
	 * @param operateLog
	 */
	public static void saveLog(AbstractEvent event,SysOperateLog operateLog){
		if (operateLog==null) {
			return ;
		}
		...
		SecurityUserHolder userHolder=new SecurityUserHolder();
  ...
  //根据类全路径获取对应属性名和属性中文
    ...
    public static void main(String[] args) {
		...
		String chinaName = listener.getChinaName("cn.mauth.ccrm.modo.model.VerificationCode");
		log.info(chinaName+"===");
		Map<String,Object>  ms= listener.getFeildsName ("cn.mauth.ccrm.modo.model.VerificationCode");
