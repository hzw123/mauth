...
if (typeof(SWFUpload) === "function") {
	...
	SWFUpload.prototype.updateTracking = function (file, bytesUploaded) {
		...
		if (!tracking.start_time) {
			tracking.start_time = (new Date()).getTime();
			tracking.lastTime = tracking.start_time;
		...
		} else if (tracking.start_time > tickTime) {
			...
			tracking.averageSpeed = (tracking.bytesUploaded * 8) / ((now - tracking.start_time) / 1000);
			...
			tracking.timeElapsed = (now - tracking.start_time) / 1000;
