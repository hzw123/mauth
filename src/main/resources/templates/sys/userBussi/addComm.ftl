	...
	<form action="" name="frmId" id="frmId"  target="_self" class="layui-form" >
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			...
			<tr height="50">
				...
				<td ><input type="text" name="staff.birthday" id="birthday"	value="" readonly="readonly" class="layui-input" ></td>

			</tr>
			<tr height="32">
				<td class="formTableTdLeft" >微信号:&nbsp;</td>
				<td ><input type="text" name="user.wechatId" id="wechatId"	value="" class="layui-input" checkType="string,1"  tip="请输入微信号"></td>
			</tr>
			<tr height="50">
			...
			<tr height="32">
				...
				<td><input type="text" name="user.mobilePhone" id="mobilePhone"			value="" class="layui-input"  lay-verify='required'></td>
			</tr>
			<tr height="50">
