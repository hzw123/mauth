...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">分店管理</a>
</div>
	...
	<form action="" name="frmId" id="frmId"  target="_self" class="layui-form">
		...
		<div class="layui-form-item">
    		...
    		<div class="layui-input-inline">
				...
				value="${enterprise.name }" class="layui-input" title="用户名"	lay-verify="require">
			</div>
			<label class="layui-form-label" style="color: red">电话&nbsp;</label>
			<div class="layui-input-inline">
				<input type="text" name="enterprise.phone" id="phone" value="${enterprise.phone }" class="layui-input" title="电话"	>
			</div>
				
			<label class="layui-form-label">传真&nbsp;</label>
			<div class="layui-input-inline"><input type="text" name="enterprise.fax" id="fax"
				value="${enterprise.fax }" class="layui-input" title="传真" >
			</div>
		</div>
		<div class="layui-form-item">
