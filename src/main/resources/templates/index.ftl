...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
		...
		<#if (fn:length(resources)>9)>
		     <li class="layui-nav-item">
                 <a href="javascript:;">更多...</a>
                 <dl class="layui-nav-child">
                     <c:forEach var="resource" items="${resources}" varStatus="i" begin="9" >
                         <dd><a href="javascript:void(-1)" onclick="subMenu(${resource.dbid},this)" >${resource.title }</a></dd>
                     </c:forEach>
                 </dl>
             </li>
		</#if>
    ...
    <ul class="layui-nav layui-layout-right">
		<#if sessionScope.user.userId=='super'>
		    <li class="layui-nav-item">
