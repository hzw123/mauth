	...
	<form class="layui-form" id="frmId" name="frmId"   target="_parent" style="padding: 12px;">
		 ...
		 <c:if test="${!empty(memberCard) }">
		  ...
		  <div class="layui-form-item">
			...
			<div class="layui-inline">
			    <label class="layui-form-label">储值金额<span style="color: red">*</span></label>
			    <div class="layui-input-inline" style="width: 80px;">
			     ...
			     <label class="layui-form-label" style="width: 20px;padding: 5px 0px;text-align: center;">-</label>
			    <div class="layui-input-inline" style="width: 80px;">
		  ...
		  <div class="layui-form-item">
		  	<div class="layui-inline">
			    <label class="layui-form-label">积分比例(元/分)<span style="color: red">*</span></label>
			    <div class="layui-input-inline">
			 ...
			 <div class="layui-inline">
			    <label class="layui-form-label">折扣比例<span style="color: red">*</span></label>
			    <div class="layui-input-inline">
		 ...
		 <div class="layui-form-item">
		  	...
		  	<textarea  class="input-xlarge" name="memberCard.note" id="content" >${memberCard.note }</textarea>
		  </div>
		  <div class="layui-form-item">
