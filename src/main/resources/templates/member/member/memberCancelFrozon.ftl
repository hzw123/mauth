...
<div class="layui-container" style="margin-top:20px;width:400px">
    <form class="layui-form" id="frmId" target="_parent">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label label-required">冻结原因</label>
        ...
        <div class="layui-form-item">
		    <div class="layui-input-block">
		      <button class="layui-btn" id="submitBut" lay-submit="" lay-filter="submitButton">冻结</button>
...
<script type="text/javascript">
	layui.use(['form', 'layedit', 'laydate','upload'], function(){
	  ...
	  form.on('submit(submitButton)', function(data){
		  ...
		  $.ajax({	
				url : '${ctx}/member/saveMemberCancelFrozon',
				data : params, 
				async : false, 
				timeout : 20000, 
				dataType : "json",
