...
<div class="layui-container" style="margin-top:20px;width:400px">
    <form class="layui-form" id="frmId" target="_parent">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label label-required">当前余额</label>
            <div class="layui-input-block" style="width:250px">
                <input type="text" disabled="disabled" name="member.overagePiont" value="${member.balance }"  class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label label-required">
            	${param.type==1?'加余额':'减余额' }<span style="color: red">*</span>
            </label>
            <div class="layui-input-block" style="width:250px">
                <input type="number" name="money" id="money" placeholder="" lay-verify="required" autocomplete="off" class="layui-input"></input>
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript">
	layui.use(['form', 'layedit', 'laydate','upload'], function(){
	  ...
	  form.on('submit(submitButton)', function(data){
		  ...
		  $.ajax({	
				url : '${ctx}/member/saveChanageBalance',
				data : params, 
				async : false, 
				timeout : 20000, 
				dataType : "json",
