    ...
    <form class="layui-form" id="frmId" target="_parent">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:450px">
                <input type="text" name="onlineBooking.mobilePhone" id="mobilePhone" value="${onlineBooking.maleNum}" lay-verify="required" placeholder="电话" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
			<label class="layui-form-label label-required">预约时间</label>
            <div class="layui-input-inline" style="width:450px">
                <input type="text" name="onlineBooking.bookingDate" id="bookingDate" value="${onlineBooking.bookingDate}" lay-verify="date" placeholder="yyyy年MM月dd日" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label label-required">人数<span style="color: red;">*</span></label>
            <div class="layui-input-inline" style="width:450px">
                <input type="text" name="onlineBooking.maleNum" id="mobilePhone" value="${onlineBooking.maleNum}" lay-verify="required" placeholder="人数" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label label-required">预约技师<span style="color: red;">*</span></label>
            <div class="layui-input-inline" style="width:450px">
            	<select id="artificerId" name="artificerId" class="layui-input" lay-verify="required">
