...
<body>
    <div class="location">
        ...
        <a href="javascript:void(-1);" onclick="window.location.href='${ctx}/startWriting/queryCousumptionList'">消费记录</a>
    </div>
    <!-- <div class="layui-container">
        <div class="layui-row">
            <div class="layui-col-xs3">
                <div class="grid-demo grid-demo-bg1">会员总数<br />12</div>
            </div>
            <div class="layui-col-xs3">
                <div class="grid-demo">会员累计冲卡<br />￥10000</div>
            </div>
            <div class="layui-col-xs3">
                <div class="grid-demo grid-demo-bg1">会员卡卡面余额<br />￥10000</div>
            </div>
            <div class="layui-col-xs3">
                <div class="grid-demo">今日冲卡<br />￥10000</div>
            </div>
        </div>
    </div> -->
...
<table class="layui-table" lay-data="{url:'${ctx}/startWriting/queryJson', page:true, id:'idTest',limit:10,method:'post'}" lay-filter="demo">
  <thead>
    <tr>
      ...
      <th lay-data="{field:'startOrderTime',align:'center', width:160}" >开单时间</th>
      <th lay-data="{field:'money',align:'center', width:100}" >订单金额</th>
      <th lay-data="{field:'discountPrice',align:'center', width:90}" >折扣金额</th>
      <th lay-data="{field:'acturePrice',align:'center', width:90}" >实收金额</th>
      <th lay-data="{field:'orderStatus',align:'center', width:90,templet:'#orderStatus'}" >订单状态</th>
      <th lay-data="{field:'orderItemDetial',align:'center',width:300}" >订单信息</th>
      <th lay-data="{field:'payWay',align:'center', width:120}" >付款方式</th>
      <th lay-data="{field:'infromType',align:'center', width:120,templet:'#infromType'}" >订单来源</th>
...
<script type="text/html" id="infromType">
  {{# if(d.infromType===1){ }}
 	 <span style="color:;" >正常开单</span>
  {{# } }}
  {{# if(d.infromType===2){ }}
 	 <span style="color:;" >补录订单</span>
  {{# } }}
</script>
<script type="text/html" id="barDemo">
   ...
   {{# if(d.orderStatus===1){ }}
 	 <a class="layui-btn layui-btn-mini" lay-event="cash">收银</a>
  	 <a class="layui-btn layui-btn-danger layui-btn-mini" lay-event="cancel">取消订单</a>
  {{# } }}
  {{# if(d.orderStatus===2){ }}
 	<a class="layui-btn layui-btn-mini" lay-event="edit">重打小票</a>
  {{# } }}
  {{# if(d.orderStatus===3){ }}
