...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="window.location.href='${ctx}/weixinAccount/queryList'">公众账号设置</a>-
...
<form class="layui-form" method="post" action="" 	name="frmId" id="frmId" >
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<select id="accounttype" name="weixinAccount.accounttype" lay-verify="required"  tip="请选择公众号类型！">
...
var layer;
	...
	//时间选择器
	  ...
	  form.on('submit(submitButton)', function(data){
		  submitFrm('${ctx}/weixinAccount/save');
		  return false
	  });
	});
</script>
