...
layui.use(['form', 'table', 'jquery',"laydate"], function () {
    ...
    table.render({
        elem: '#tData',
        method: 'post',
        url: '../statistic/queryProject',
        cols: [[
      	      { field: 'itemName', title: '名称' , width: 160},
      	      { field: 'money', title: '单价' , width: 80},
      	      { field: 'num', title: '数量' , width: 80},
      	      { field: 'totalMoney', title: '总金额' , width: 80},
      	      { field: 'vipDiscount', title: '会员折扣', width: 80},
      	      { field: 'freeVip', title: '会员卡赠送' , width: 80},
    	      ...
    	      { field: 'otherDiscount', title: '其它方式' , width: 80},
    	      { field: 'payment', title: '实付金额' , width: 80}
      	    ]],
        id: 'tData',
        page: false
    });
