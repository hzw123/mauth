...
layui.use(['form', 'table', 'jquery',"laydate"], function () {
    ...
    table.render({
        elem: '#tData',
        method: 'post',
        url: '../statistic/queryMemconsume',
        cols: [[
      	      { field: 'memName', title: '姓名' , width: 120},
      	      { field: 'num', title: '次数' , width: 80},
      	      { field: 'money', title: '金额' , width: 80},
      	      { field: 'avg', title: '平均消费' , width: 80},
      	      { field: 'payment', title: '实付' , width: 80},
      	      { field: 'vipDiscount', title: '会员卡折扣' , width: 120},
      	      { field: 'vipFree', title: '会员卡赠送', width: 80},
      	      { field: 'countCard', title: '次卡' , width: 80},
      	      { field: 'freeTicket', title: '项目券' , width: 80},
    	      ...
    	      { field: 'otherDiscount', title: '其它优惠' , width: 80},
      	      { field: 'actualMoney', title: '实付金额' , width: 80},
      	      { field: 'discountMoney', title: '优惠金额' , width: 80},
